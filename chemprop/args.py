...
Metric = Literal['auc', 'prc-auc', 'ap50', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy', 'binary_cross_entropy', 'sid', 'wasserstein']
...
class CommonArgs(Tap):
    ...
    smiles_columns: List[str] = ['smiles_1', 'smiles_2']  # Changed
    """List of names of the columns containing SMILES strings.
    By default, uses the first :code:`number_of_molecules` columns."""
    number_of_molecules: int = 2  # Changed
    ...
    no_features_scaling: bool = True  # CHANGED
    ...
    """
    feature_dimension_reduction: str = None  # CHANGED
    """
...
class TrainArgs(CommonArgs):
    ...
    """
    calc_train_auc: bool = False  # Changed
    """
    Whether to show training accuracy, auc, auprc, and ap50 or not.
    """
    ...
    def process_args(self) -> None:
        ...
        for metric in self.metrics:
            if not any([(self.dataset_type == 'classification' and metric in ['auc', 'prc-auc', 'accuracy', 'binary_cross_entropy', 'ap50']),  # CHANGED
