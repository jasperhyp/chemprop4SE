...
class MoleculeModel(nn.Module):
    ...
    def create_ffn(self, args: TrainArgs) -> None:
        ...
        if args.features_only:
            ...
            first_linear_dim = args.hidden_size  # Changed
            if args.use_input_features and args.feature_dimension_reduction!='linear-layer':
                first_linear_dim += args.features_size
            elif args.use_input_features:
                first_linear_dim += 256  # Changed
